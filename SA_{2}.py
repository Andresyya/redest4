...
def build_model():
    ...
    model.add(Dense(100, activation='sigmoid', kernel_regularizer=tf.keras.regularizers.l2(0.01)))
    model.add(Dense(200, activation='sigmoid', kernel_regularizer=tf.keras.regularizers.l2(0.01)))
    model.add(Dense(200, activation='sigmoid' , kernel_regularizer=tf.keras.regularizers.l2(0.01)))
    model.add(Dense(100, activation='sigmoid', kernel_regularizer=tf.keras.regularizers.l2(0.01)))
